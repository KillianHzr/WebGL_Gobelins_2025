...
import { TextureLoader, SRGBColorSpace, Color, Fog } from 'three';
...
const BackgroundWithFog = () => {
    ...
    const fogConfigRef = useRef({
        ...
        initialNear: 100, // Très éloigné (invisible au début)
        initialFar: 120,  // Très éloigné (invisible au début)
    ...
    useEffect(() => {
        ...
        loader.load(
            ...
            (texture) => {
                ...
                console.log('Image de fond chargée et brouillard initialisé');
            },
            // Progression
            (xhr) => {
            ...
            (error) => {
                ...
                // En cas d'erreur, initialiser quand même le brouillard
                bgColorRef.current = new Color(fogConfigRef.current.color);
                scene.fog = new Fog(
                    bgColorRef.current,
                    fogConfigRef.current.initialNear,
